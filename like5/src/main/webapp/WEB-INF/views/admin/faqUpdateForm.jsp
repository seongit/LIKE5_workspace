...
<div class="innerOuter">
    ...
    <form action="updateFaq.ad" method="post" class="enrollForm">
        ...
        <br><br>
        <input type="text" name="question" class="question" value="${f.question}">
        <br><br>
        <textarea name="answer" class="answer">${f.answer}</textarea>
        <br><br>
